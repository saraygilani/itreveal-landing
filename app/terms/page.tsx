...
export const metadata: Metadata = {
  title: "Terms & Conditions | ItReveal",
  description:
    "Terms and conditions for the ItReveal mobile app and related services operated by ItReveal Labs.",
};
      ...
      <article className="mt-8 space-y-9 bg-white/80 p-6 shadow-[0_12px_40px_rgba(40,33,20,0.06)] ring-1 ring-stone-200 sm:p-8">
        <header className="space-y-4">
          ...
          <p className="text-sm leading-7 text-stone-700">
            These terms and conditions apply to the ItReveal app for mobile
        ...
        <div className="space-y-9 text-sm leading-7 text-stone-700">
          <TermsSection title="License to use the Application">
            <p>
              ...
              decompile, or disassemble the Application, except as and only to
          ...
          <TermsSection title="Intellectual Property">
            <p>
              ...
              marks, trade names, logos, and branding (the &quot;IP&quot;).
              Nothing in these Terms grants you any license or right to use the
              Service Provider&apos;s trademarks, logos, or branding for any
              purpose. You agree not to remove, alter, or obscure any copyright,
              trademark, or other proprietary notices displayed in or on the
              Application.
            </p>
          </TermsSection>
          ...
          <TermsSection title="Termination">
            ...
            <p>
              ...
              intellectual property rights, or engage in activity that could
              cause harm to other users or the Service Provider.
            </p>
            <p>
            ...
            <p>
              ...
              legally permitted to use it in your jurisdiction. You must be at
              least 13 years of age (the age of digital consent in your
              jurisdiction) to use the Application. If you are below 13, a parent
            ...
            <p>
              ...
              the Application, or the Service Provider&apos;s trademarks is
          ...
          <TermsSection title="User-Generated Content and Acceptable Use">
            <p>
              If this Application allows users to post, share, or upload
            ...
            <TermsList>
              <li>
                Remove or disable access to content that violates these
                guidelines
              </li>
              <li>
            ...
            <p>
              ...
              itreveal.app@gmail.com. The report should include enough
              information for the Service Provider to identify the content,
            ...
            <p>
              The Service Provider may review reported content, request
              additional information where necessary, remove or restrict access
              to content, and take action against the responsible account where
              appropriate. Users affected by moderation decisions may contact the
              Service Provider at itreveal.app@gmail.com to request further
              review. The Service Provider will respond to appeals within a
              reasonable period and provide the reasons for any upheld moderation
            ...
            <p>
              ...
              Provider&apos;s business. This license does not grant the Service
              Provider the right to sell or sublicense your content to third
              parties independently of the Application. You represent and warrant
              that you own or control all rights in the content you post and that
            ...
            <p>
              ...
              related to User-Generated Content is governed by the Privacy
              Policy. Do not post personal data of others without their consent.
            </p>
          </TermsSection>

          <TermsSection title="Application Services and Device Responsibility">
            <p>
            ...
            <p>
              ...
              applicable consumer protection laws that cannot be lawfully
              excluded.
            </p>
          </TermsSection>
          ...
          <TermsSection title="Limitation of Liability">
            <p>
              ...
              data loss, or business interruption, even if advised of the
            ...
            <p>
              ...
              Service Provider for any claim shall not exceed the amount paid by
              you to the Service Provider for the Application in the 12 months
              preceding the claim, or the minimum amount that must be paid under
              applicable law, whichever is greater. If the Application is
              provided free of charge, this means the Service Provider&apos;s
              liability is limited to the minimum amount permitted by applicable
              law.
            </p>
            <p>
          ...
          <TermsSection title="Indemnification">
            <p>
              ...
              legal fees, arising out of or directly related to your breach of
              these Terms or your intentional misuse of the Application,
              including User-Generated Content you submit in violation of these
              Terms.
            </p>
            <p>
              This indemnification does not apply to claims arising from the
              Service Provider&apos;s own negligence, breach of these Terms, or
              violation of applicable law. In jurisdictions where consumer
              indemnification is restricted by law, this clause shall be limited
            ...
            <p>
              ...
              system version installed on your device. You should accept updates
              when offered; if you choose not to, the Service Provider may cease
              to support earlier versions and the Application may not function
          ...
          <TermsSection title="Governing Law and Jurisdiction">
            <p>
              These Terms and Conditions are governed by the laws of the
              jurisdiction in which the Service Provider is established,
              excluding conflict of law rules, except to the extent mandatory
              consumer protection laws provide otherwise.
            </p>
            <p>
              Any dispute arising out of or relating to these Terms will be
              brought before the courts that have jurisdiction under applicable
              law. Nothing in this clause limits any rights you may have to bring
              a claim in a court that is competent under mandatory law.
            </p>
          </TermsSection>

          <TermsSection title="DSA Compliance (Digital Services Act)">
            <p>
              If the Application is an intermediary service as defined under the
              Digital Services Act (Regulation (EU) 2022/2065, &quot;DSA&quot;),
              the following provisions apply in addition to the terms above.
            </p>
            <p>
              Point of Contact: The Service Provider maintains a single point of
              contact for direct communication with EU authorities and recipients
              of the service, reachable at itreveal.app@gmail.com. Where the
            ...
            <p>
              Content Moderation and Statement of Reasons: When the Service
              Provider restricts access to content, suspends or terminates an
              account, or otherwise limits the availability of the
              Application&apos;s features, a clear and specific statement of
              reasons will be provided to the affected user. The statement will
              include the nature of the restriction, the legal or contractual
              basis for the decision, and information on available redress
              mechanisms, in accordance with Article 17 of the DSA.
            </p>
            <p>
              Notice and Action: Users and third parties may submit notices of
              allegedly illegal content through the contact details provided in
              these Terms. The Service Provider will process notices promptly,
              diligently, and without automated decision-making where the
            ...
            <p>
              Out-of-Court Dispute Settlement: Disputes regarding content
              moderation decisions, including decisions to restrict content or
              suspend accounts, may be submitted to an out-of-court dispute
              settlement body certified in accordance with Article 21 of the DSA.
              The Service Provider will engage with such bodies in good faith.
              Use of out-of-court dispute settlement does not affect your right
              to seek judicial remedy under applicable law.
            </p>
            <p>
              Transparency Reporting: The Service Provider publishes periodic
              transparency reports covering content moderation activities,
              including the volume of notices received, actions taken, and
              automated means used, in accordance with Article 24 of the DSA.
              Reports are made available upon request at itreveal.app@gmail.com.
            </p>
            <p>
              ...
              replace or limit any rights or obligations under applicable
          ...
          <TermsSection title="Entire Agreement">
            <p>
              ...
              Provider concerning your use of the Application, superseding any
              prior agreements or understandings.
            </p>
          </TermsSection>

          <TermsSection title="Changes to These Terms and Conditions">
            <p>
            ...
            <p>
              ...
              at itreveal.app@gmail.com.
            </p>
            <p>These terms and conditions are effective as of 2026-06-25</p>
          </TermsSection>
